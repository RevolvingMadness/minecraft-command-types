...
macro_rules! create_enum {
    (
        ...
        #[derive(Debug, Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, ::strum::Display, ::strum::EnumString, ::minecraft_command_types_procedural_macros::HasMacro, ::serde::Serialize, ::serde::Deserialize, $($custom_derives),*)]
    ...
    (
        ...
        #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, ::strum::Display, ::strum::EnumString, ::minecraft_command_types_procedural_macros::HasMacro, ::serde::Serialize, ::serde::Deserialize, $($custom_derives),*)]
