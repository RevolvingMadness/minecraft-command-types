...
macro_rules! create_enum {
    (
        ...
        #[derive(Debug, Copy, Clone, Eq, PartialEq, PartialOrd, Ord, Hash, ::strum::Display, ::strum::EnumString, ::minecraft_command_types_procederal_macros::HasMacro, ::serde::Serialize, ::serde::Deserialize, $($custom_derives),*)]
    ...
    (
        ...
        #[derive(Debug, Clone, Eq, PartialEq, PartialOrd, Ord, Hash, ::strum::Display, ::strum::EnumString, ::minecraft_command_types_procederal_macros::HasMacro, ::serde::Serialize, ::serde::Deserialize, $($custom_derives),*)]
